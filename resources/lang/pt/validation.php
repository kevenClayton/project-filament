...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'contact_phone' => 'contacto telefónico',
        'contact' => 'contacto',
        'postal_code' => 'código postal',
        'address' => 'morada',
        'municipality' => 'concelho',
        'headquarters_municipality' => 'concelho da sede',
        'knowledge_source' => 'fonte de conhecimento',
        'company_size' => 'tamanho da empresa',
        'sustainability_policy' => 'política de sustentabilidade',
        'energy_efficiency' => 'eficiência energética',
        'waste_reduction' => 'redução de resíduos',
        'renewable_energy' => 'energia renovável',
        'sustainable_purchases' => 'compras sustentáveis',
        'co2_reduction' => 'redução de CO2',
        'water_reduction' => 'redução de água',
        'environmental_monitoring' => 'monitorização ambiental',
        'employee_practices' => 'práticas com funcionários',
        'esg_responsible' => 'responsável ESG',
        'esg_goals' => 'metas ESG',
        'esg_communication' => 'comunicação ESG',
        'business_ethics' => 'ética empresarial',
        'sustainability_maturity' => 'maturidade em sustentabilidade',
        'publishes_esg_reports' => 'publicação de relatórios ESG',
        'esg_frameworks' => 'frameworks ESG',
        'sustainability_evolution' => 'evolução da sustentabilidade',
        'sustainability_challenges' => 'desafios de sustentabilidade',
        'sustainability_motivations' => 'motivações para sustentabilidade',
        'initial_challenge' => 'desafio inicial',
        'scope_of_action' => 'âmbito de atuação',
        'actors_involved' => 'atores envolvidos',
        'objectives' => 'objetivos',
        'actions' => 'ações',
        'results' => 'resultados',
        'ods_impact' => 'impacto ODS',
